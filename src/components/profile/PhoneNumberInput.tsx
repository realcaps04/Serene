    ...
    <div className="px-4 py-3.5">
        ...
        <div ref={pickerRef} className="relative shrink-0">
          ...
          {pickerOpen ? (
            <ul
              ...
              className="absolute left-0 top-[calc(100%+6px)] z-20 max-h-52 w-56 overflow-y-auto overscroll-contain rounded-xl border border-[#E8EAF2] bg-white py-1 shadow-[0_12px_32px_rgba(15,23,42,0.14)]"
            >
      ...
      {localError ? (
        ...
        <p className="mt-2 text-[11px] text-[#16A34A]">
          Valid {country.name} mobile format
        </p>
      ) : (
