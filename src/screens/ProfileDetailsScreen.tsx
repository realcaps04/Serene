...
type FieldKey = keyof ProfileDetails;
...
const FIELDS: {
  ...
  { key: "contactNumber", label: "Contact Number", icon: Phone, placeholder: "+1 000 000 0000", inputMode: "tel" },
];
        ...
        <div className="fixed inset-0 z-[100]">
          ...
          >
            <div
              ...
              className="max-h-[min(92dvh,820px)] touch-pan-y overflow-y-auto overscroll-contain rounded-t-[28px] bg-gradient-to-b from-[#FFFBFE] via-[#FAF7FF] to-white shadow-[0_-12px_48px_rgba(15,23,42,0.18)] [-webkit-overflow-scrolling:touch]"
            >
            <div className="sticky top-0 z-10 bg-gradient-to-b from-[#FFFBFE] via-[#FAF7FF] to-[#FAF7FF]/95 px-5 pb-2 pt-3 backdrop-blur-sm">
            ...
            <div className="px-5 pb-[max(20px,env(safe-area-inset-bottom))]">
              ...
              <div className="overflow-hidden rounded-[22px] bg-white shadow-[0_6px_24px_rgba(15,23,42,0.06)]">
                {FIELDS.slice(0, 2).map((field) => {
                  ...
                  return (
                    <div
                      key={field.key}
                      className="border-b border-[#F0F1F5]"
                    >
                      <button
                        type="button"
                ...
                {FIELDS.slice(2).map((field, index) => {
                  ...
                  return (
                    <div
                      key={field.key}
                      className={index < FIELDS.length - 1 ? "border-b border-[#F0F1F5]" : undefined}
                    >
                      <button
                        type="button"
                        onClick={() => setActiveField(field.key)}
              ...
              <div className="mt-5 pb-2">
                ...
                <p className="mt-4 flex items-center justify-center gap-1.5 text-[11px] text-[#9499A8]">
